---
title: [Intermediate_ML_1]결측값을 처리하는 방법에 대해 알아보자!
layout: post   
categories : [ML, kaggle, Imputation, Missing Value]
image : assert/img/수료증/shshuu-Intermediate_ML.png
...
![approach_1](assert/img/Itm_ML_01_approach1.JPG)
...
![approach_2](assert/img/Itm_ML_02_approach2.JPG)
...
![approach_3](assert/img/Itm_ML_03_approach3.JPG)
