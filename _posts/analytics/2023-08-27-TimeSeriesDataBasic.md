...
plt.show()
```
![사진5](/assets/img/study/analytics/hannah/사진5.png)</br> 
...
plt.show()
```
![사진8](/assets/img/study/analytics/hannah/사진8.png)</br>
...
1. 잔차의 평균 :잔차의 평균이 0에 가까울수록 모델이 데이터를 잘 설명하고 있다는 뜻이다. </br>
