...
![fig. 9.](/assets/img/O2O%20Fig.9.png)
...
- **(3-1) 매장-지역 모델링.** 한편, 대상 노드 매장 지역의 경우 $E^t_{S-U}$를 통해 배송 범위 내에서 고객-지역의 선호도를 학습한다(propagation). 반면 $E_{S-A}$ 를 통해 매장-지역과 매장-유형 간으 ㅣ상위 상호 작용 정보를 관측한다. I번째 집계 후 매장-지역 노드 s의 임베딩 $h^l_{s,t}$ 는 다음과 같이 정의한다. 
![E-7](/assets/img/수식%20쪼가리/E-7.png)  
...
![E-8](/assets/img/수식%20쪼가리/E-8.png)  
